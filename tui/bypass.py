...
class CF_Solver:
    ...
    This solver was directly sourced from proplayer919's github.  
    Thank you for the save as I hate writing anything with selenium.
    https://github.com/proplayer919/Cloudflare-Bypass/tree/main
    """
    ...
    async def bypass(self, timeout: int = 0) -> str:
        ...
        raise Exception("Timed out waiting for cf_clearance cookie. Challenge may be too heavy.")
